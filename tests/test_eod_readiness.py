...
class EodReadinessTests(unittest.TestCase):
    ...
    def finalized_state(self, day: str, pnls=(0.5,)):
        ...
        for index, pnl in enumerate(pnls):
            ...
            state["completed_shadow_trades"].append({"attribution": "SHADOW_AI", "plan_id": plan_id, "symbol": "TEST", "pnl": pnl, "realized_r": pnl, "hypothetical_notional": 20, "mfe": 0.7, "mae": -0.2, "setup_type": "BASE_BREAKOUT", "market_regime": "TRENDING_BULLISH", "catalyst_classification": "VERIFIED_FRESH", "time_of_day": "10:05", "entry_timestamp": entry, "exit_timestamp": exit_time})
